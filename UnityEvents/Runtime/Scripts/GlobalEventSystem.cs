...
namespace UnityEvents
{
   ...
   {
      private static readonly TickEventSystem _simSystem = new TickEventSystem(EventUpdateTick.FixedUpdate);
      private static readonly TickEventSystem _uiSystem = new TickEventSystem(EventUpdateTick.LateUpdate);
